  ...
  return (
    <div className={`container ${isDarkMode ? "dark" : "light"}`}>
      <section className="sectionInit">
        ...
        <h2>💛 ¿Cómo ayudamos?</h2>
        <p>Rescatamos animales en peligro, les proporcionamos atención veterinaria, alimentación y cariño mientras buscamos la familia ideal para ellos.</p>

        <h2>🏡 Adopta, cambia una vida</h2>
        <p>Miles de animales esperan un hogar. Si estás buscando un nuevo compañero de vida, ¡descubre nuestras adorables mascotas en adopción!</p>

        <h2>🤝 Únete a nuestra causa</h2>
        <p>Puedes ayudarnos de muchas maneras: hazte voluntario, apadrina un animal o contribuye con una donación para que sigamos salvando vidas.</p>
